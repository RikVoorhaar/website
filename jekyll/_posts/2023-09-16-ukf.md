...
> It's ok... but it has a habit of sneaking in all over your codebase, and still  has a fair bit of boilerplate

### ndarray vs numpy

> ndarray can be really annoying to use. It's nice to have distinction between views and owned copies of arrays, but this can get very frustrating when trying to do simple operations. On the other hand, with numpy you end up doing a lot of unecesary copying, which does have pretty large overhead. 
